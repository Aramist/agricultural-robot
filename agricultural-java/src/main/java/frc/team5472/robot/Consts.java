...
public class Consts {
    ...
    // Frames used when communicating with Jetson
    public static final String LEAD_DRIVE = "lead_drive";
    public static final String TRAIL_DRIVE = "trail_drive";

    public static final String LEAD_IMU = "lead_imu";
    public static final String TRAIL_IMU = "trail_imu";
